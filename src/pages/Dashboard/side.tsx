...
export default function Side() {
  return (
    <>
    <Grid container bgcolor={'#CBEEF0'}>
    <Grid xs={12}   container spacing={0}  direction={{xs:"row",sm:'row',md:"row"}} >
    ...
    <Grid xs={12} sm={12}  md={4}  padding={1}>
      ...
      <Grid xs={12} sm={12}  md={4}  padding={1} sx={{
              display: 'flex',
              flexDirection: { xs: 'row', sm: 'row', md: "column" },
            }} >
      <Grid xs={6} sm={6} md={12} padding={1}>
      <Box sx={{height:'15vh',backgroundColor:"#A4BFF4",borderRadius:"15px"}}> </Box>
      </Grid>
      <Grid xs={6} sm={6} md={12} padding={1}>
      <Box sx={{height:'15vh',backgroundColor:"#A4BFF4",borderRadius:"15px"}}> </Box>
      </Grid>
      ...
      <Grid xs={12} sm={12} md={8}  padding={1}><Box sx={{height:'430px',backgroundColor:"#EFEFEF",borderRadius:"15px"}}>
            <LineChart
        // width={600}
        // height={500}
        series={[
      ...
      <Grid xs={12} sm={12} md={4}  padding={1}><Pie></Pie></Grid>
      </Grid>
