...
const SearchBar = () => {
  return (
    <Grid
      ...
      margin="-10px"
      width="101vw"
      sx={{ boxShadow: '3.5px 3.5px 3.5px rgba(0, 0, 0, 0.3)', zIndex: '4' }}
    >
      <Grid
        xs={2}
        sm={1}
        ...
        sx={{
          ...
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center', // Move the MenuIcon to the right
          width: '40%',
          height: 40,
        }}
      ...
      <Grid xs={9} sm={9} md={9} >
        <Grid
          ...
          sm={5}
          sx={{
            backgroundColor: 'rgba(203, 238, 240, 0.2)',
            borderRadius: '15px',
            marginTop: '5px',
            zIndex: '5',
            backdropFilter: 'blur(10px)',
            display: 'flex', // Added this to center items horizontally
          }}
        >
          <Grid xs={10}>
           <InputBase
              sx={{ ml: 1, flex: 1, display: 'flex', alignItems: 'center', color: 'white' }}
              placeholder="   Search.."
            />
          </Grid>
          <Grid container xs={2} sx={{ justifyContent: 'flex-end' }}> {/* Align SearchIcon to the right */}
            <IconButton type="button" aria-label="search" sx={{ display: 'flex', alignItems: 'center', height: 30, color: 'white' }}>
              <SearchIcon sx={{ color: 'white' }} />
            </IconButton>
          </Grid>
      ...
      <Grid
        ...
        sx={{
          ...
          alignContent: 'center',
          color: '#EFEFEF',
          justifyContent: 'flex-end', // Move right icons to the right
        }}
      >
        <Grid sm={4} md={4} display={{ xs: 'none', sm: 'block' }}>
          <NotificationsIcon />
        ...
        <Grid xs={12} sm={0} md={0} display={{ xs: 'block', sm: 'none' }}>
          <MoreIcon></MoreIcon>
        </Grid>
      </Grid>
    </Grid>
